...
const Org = require('../models/orgModel'); // Assuming your Sequelize model is named Org
...
exports.getRecord = catchAsync(async (req, res) => {
  ...
  const row = await Org.findByPk(id);
...
exports.addObject = catchAsync(async (req, res) => {
  try {
    ...
    console.log(timeNow);
    const newRecord = await Org.create({
      ...payload,
      sid: timeNow,
      rss: timeNow,
      lct: timeNow,
...
exports.updateObject = catchAsync(async (req, res) => {
  try {
    ...
    const existingRecord = await Org.findByPk(id);
    ...
    const updatedRecord = await Org.findByPk(existingRecord.id);
...
exports.getListOrg = catchAsync(async (req, res) => {
  try {
