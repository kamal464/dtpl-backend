...
exports.getRecord = catchAsync(async (req, res) => {
  ...
  const row = await Settings.findByPk(id);
...
exports.updateObject = catchAsync(async (req, res) => {
  try {
    ...
    const existingRecord = await Settings.findByPk(id);
    ...
    const updatedRecord = await Settings.findByPk(existingRecord.id);
...
exports.getListSettings = catchAsync(async (req, res) => {
  try {
