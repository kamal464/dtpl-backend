...
const SchemaTable = require('../models/schematableModel'); // Assuming your Sequelize model is named SchemaTable
...
exports.getAllRecords = catchAsync(async (req, res) => {
  try {
    ...
    const rows = await SchemaTable.findAll({
...
exports.addObject = catchAsync(async (req, res) => {
  try {
    ...
    console.log(timeNow);
    const newRecord = await SchemaTable.create({
      ...payload,
      sid: timeNow,
      rss: timeNow,
      lct: timeNow,
...
exports.updateObject = catchAsync(async (req, res) => {
  try {
    ...
    const existingRecord = await SchemaTable.findByPk(id);
    ...
    const updatedRecord = await SchemaTable.findByPk(existingRecord.id);
...
exports.getListSchemaTable = catchAsync(async (req, res) => {
  try {
